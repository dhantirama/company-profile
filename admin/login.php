...
if (isset($_POST['login'])) {
    ...
    //mysqli_num_row (bawaan dari php): untuk melihat total data dalam tabel
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="#" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Dhanram</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Dhanram 👋</h4>
                        <p class="mb-4">Please Sign in To Start Your Journey</p>
