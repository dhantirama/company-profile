...
$queryUser = mysqli_query($koneksi, "SELECT * FROM contact WHERE deleted_at IS NULL");
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    <?php $no = 1;
                                                    $rowContacts = mysqli_fetch_all($queryUser, MYSQLI_ASSOC);
                                                    foreach ($rowContacts as $row) { ?>
                                                        <tr>
                                                            <td><?php echo $no++ ?></td>
                                                            ...
                                                            <td><a href="kirim-pesan.php?pesanId=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm"><span class="tf-icon bx bx-pencil bx-18px"></span></a> <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')" href="contact-admin.php?delete=<?php echo $row['id'] ?>" class="btn btn-secondary btn-sm"><span class="tf-icon bx bx-trash bx-18px"></span></a></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
